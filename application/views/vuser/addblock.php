<div class="container" style="padding-left:10%;padding-right:13%">
  <div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title">New Block</h3>
    </div>
    <div class="panel-body">
      <div class="well well-sm">Create a new Block to continue, or take a look at the <a href="<?php echo site_url('Welcome/manual');?>">Manual</a> first?</div>
...
</div><!--container ~ to suppress the NewBlock Form-->
<script>
